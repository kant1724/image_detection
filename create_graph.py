...
flags.DEFINE_string('input_type', 'image_tensor', 'Type of input node. Can be '
                    ...
                    '`tf_example`]')
flags.DEFINE_string('pipeline_config_path', './faster_rcnn_resnet50.config',
                    'Path to a pipeline_pb2.TrainEvalPipelineConfig config '
                    'file.')
flags.DEFINE_string('trained_checkpoint_prefix', './training_data/3. ckpt_files/model.ckpt-81655',
                    'Path to trained checkpoint, typically of the form '
                    'path/to/model.ckpt')
flags.DEFINE_string('output_directory', './training_data/4. pb_files', 'Path to write outputs.')
